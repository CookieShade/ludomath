...
#[test]
fn rot_slerp_endpoints() {
    let r1 = Rotation::new_deg(-35.0);
    let r2 = Rotation::new_deg(32.0);
    assert_approx(r1.slerp(r2, 0.0), r1);
    assert_approx(r1.slerp(r2, 1.0), r2);
}

#[test]
fn rot_slerp_midpoint() {
...
#[test]
fn num_inv_sqrt() {
    assert!((num::inv_sqrt(2.0) - 1.0/2.0f32.sqrt()).abs() < 0.001);
}
